...
# PROJECT: boltnew
# FRAMEWORK: react
# PATH: /data/data/com.termux/files/home/c25-complete-build-20260316_191225/obsidian/Obsidian/Termux_Sync/Saved/Documents/Obsidian/termux-home/repos/bolt.new
# AGENT: Mars
# GENERATED: Fri Mar 20 21:48:39 EDT 2026

echo "━━━ Mars building: boltnew [react]"
cd "/data/data/com.termux/files/home/c25-complete-build-20260316_191225/obsidian/Obsidian/Termux_Sync/Saved/Documents/Obsidian/termux-home/repos/bolt.new" || exit 1
...
[ ! -f "style.css" ] && echo "/* boltnew styles */body{margin:0;font-family:sans-serif;background:#0a0a0f;color:#f8fafc}" > style.css
