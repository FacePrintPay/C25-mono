...
echo "━━━ Mars building: c25-c25-mirror-push [static]"
cd "/data/data/com.termux/files/home/github-repos/Constellation25/c25-c25-mirror-push" || exit 1
...
<title>c25-c25-mirror-push</title>
...
[ ! -f "style.css" ] && echo "/* c25-c25-mirror-push styles */body{margin:0;font-family:sans-serif;background:#0a0a0f;color:#f8fafc}" > style.css
